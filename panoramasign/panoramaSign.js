...
const clearAllRelaysTelegramConstructor = async () => {
  ...
  let telegrams = [
    ...
    // clear message field
    [STX, 0x06, 0x08, 0x07, 0x07, ...end],
    [STX, 0x08, 0x08, 0x07, 0x07, ...end],
    [STX, 0x0a, 0x08, 0x07, 0x07, ...end],
    [STX, 0x0b, 0x08, 0x07, 0x07, ...end],
    [STX, 0x0c, 0x08, 0x07, 0x07, ...end],
    [STX, 0x0d, 0x08, 0x07, 0x07, ...end],
    [STX, 0x0e, 0x08, 0x07, 0x07, ...end],
    [STX, 0x0f, 0x08, 0x07, 0x07, ...end],
  ];
  return telegrams;
}
